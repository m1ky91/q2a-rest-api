...
return array(
		'rest_api_intro_1' => 'Benvenuto alle REST API. Di seguito troverai l\'intera 
								lista dei servizi disponibili.',
		
		'rest_api_intro_2' => 'Per ulteriori informazioni su un particolare servizio,
		...
		'rest_api_users_desc' => 'Visualizza le informazioni degli utenti come: id utente, 
									username, punti, numero di domande e numero di risposte.',
		
		'rest_api_users__users_' =>	'Carica una lista di utenti.',
		...
		'rest_api_questions__questions_' =>	'Carica una lista di domande.',
		...
		'rest_api_categories__categories_' => 'Carica una lista di categorie.',
		...
		'rest_api_tags__tags_tagid' => 'Carica un tag.',
		
		'rest_api_request' => 'Richiesta di esempio',
		
		'rest_api_response' => 'Risposta di esempio',
		
		'rest_api_allow_use' => 'Consenti l\'uso a:',
		
		'rest_api_max_users' => 'Numero massimo di utenti nella risposta:',
		
		'rest_api_max_questions' => 'Numero massimo di domande nella risposta:',
		
		'rest_api_max_answers' => 'Numero massimo di risposte nella risposta:',
