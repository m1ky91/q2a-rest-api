...
return array (
		'rest_api_intro_1' => 'Welcome to the REST API. Below, you\'ll find a full 
								listing of all the available endpoints.',
		
		'rest_api_intro_2' => 'For more information about a particular endpoint, click 
		...
		'rest_api_users_desc' => 'View user information data such as user id, handle, 
									points, questions count and answers count.',
		
		'rest_api_users__users_' =>	'Load a list of Users.',
		...
		'rest_api_questions__questions_' =>	'Load a list of Questions.',
		...
		'rest_api_categories__categories_' => 'Load a list of Categories.',
		...
		'rest_api_tags__tags_tagid' => 'Load a Tag.',
		
		'rest_api_request' => 'Example request',
		
		'rest_api_response' => 'Example response',
		
		'rest_api_allow_use' => 'Allow use:',
		
		'rest_api_max_users' => 'Maximum number of users in response:',
		
		'rest_api_max_questions' => 'Maximum number of questions in response:',
		
		'rest_api_max_answers' => 'Maximum number of answers in response:',
